...
def main(_):
    ...
    #sentence1 = input('sentence1: ')
    #sentence2 = input('sentence2: ')
    #sentence1 = "What is the meaning of ontology?"
    #sentence2 = "How to explain ontology?"
    sentence1 = argv[1]
    sentence2 = argv[2]
    predict = sim.predict(sentence1, sentence2)
    print(f'similarity:{predict[0][1]}')
    #file = open('F:/FYP_SIMI/BertSimilarity-master/tempSimi.txt', 'a')
    file = open('BertSimilarity/tempSimi.txt', 'a')
    file.write(str(predict[0][1]) + "\n")
    file.close()
